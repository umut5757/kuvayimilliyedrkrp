...
function DownloadingFile( fileName ) {
	...
	setStatus("addonlar,map yukleniyor...");
...
function SetStatusChanged( status ) {
	...
	if (status.indexOf("Addonlar yukleniyor... : #") != -1) {

		downloadedFiles++;

		refreshProgress();

	}else if (status == "/calladmin yazarak sikayetlerinizi veya sorularinizi yetkiliye iletebilirsiniz...") {
